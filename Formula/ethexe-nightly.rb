...
class EthexeNightly < Formula
  ...
  stable do
    on_macos do
      on_arm do
        url "https://get.gear.rs/ethexe-nightly-aarch64-apple-darwin.tar.xz"
      end

      on_intel do
        url "https://get.gear.rs/ethexe-nightly-x86_64-apple-darwin.tar.xz"
      end
    end

    on_linux do
      on_arm do
        url "https://get.gear.rs/ethexe-nightly-aarch64-unknown-linux-gnu.tar.xz"
      end

      on_intel do
        url "https://get.gear.rs/ethexe-nightly-x86_64-unknown-linux-gnu.tar.xz"
      end
    end
  end
